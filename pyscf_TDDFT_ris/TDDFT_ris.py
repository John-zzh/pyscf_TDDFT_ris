...
from pyscf_TDDFT_ris import parameter, eigen_solver
...
def gen_P(mf, mol):
    ...
    int_r= mol.intor_symmetric('int1e_r_cart')
...
class TDDFT_ris(object):
    ...
    def gen_2c_3c(self, mol, auxmol, RSH_omega=0):
        ...
        N_auxbf * N_auxbf
        '''
        eri2c = auxmol.intor('int2c2e_cart')
        '''
        ...
        print('auxmol.cart2',mol.cart)
        print('pmol.nao_nr()',pmol.nao_nr())
        print('pmol.cart',pmol.cart)
        eri3c = pmol.intor('int3c2e_cart',
    ...
    def gen_vind(self):
        ...
        alpha_RSH=None
        beta_RSH=None
        if mf.xc.lower() in parameter.RSH_F:
            '''
            ...
            a_x = parameter.Func_ax[mf.xc.lower()]
