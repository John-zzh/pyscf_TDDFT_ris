...
def gen_args():
    ...
    parser.add_argument('-f', '--files',   type=str, default=None, nargs='+', help='a lsit of spectra files')
    parser.add_argument('-ftype', '--filetypes',   type=str, default=None, nargs='+', help='the corresponding lsit of file types')
...
#     oscillator_strength = float(parts[f_index + 1])
#     return energy_ev, wavelength_nm, oscillator_strength
...
# # Example usage
# filename = 'path_to_your_gaussian_output_file.log'
# data = extract_data(filename)

# # data is a numpy array where each row is [energy_ev, wavelength_nm, oscillator_strength]
# # You can access each column separately if needed
# excitation_energies = data[:, 0]
# wavelengths = data[:, 1]
# oscillator_strengths = data[:, 2]

# # Print the extracted data
# print("Excitation Energies (eV):", excitation_energies)
